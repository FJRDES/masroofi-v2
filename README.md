...
تحديث حالة الاتصال: تغيير العبارة إلى متصل / غير متصل مع الحفاظ على تحسينات V2.3.

## الرفع
ارفع الملفات إلى GitHub Pages واستبدل الملفات الحالية، ثم Commit باسم: Masroofi V2.4 status update.
